  ...
  const floatingShapes = [
    {
      ...
      left: "5%",
      size: "w-16 h-16",
      color: "bg-accent-400/20 dark:bg-accent-600/20",
      animation: { y: [0, -20, 0], duration: 8 },
    },
    {
      id: 2,
      top: "70%",
      left: "10%",
      size: "w-10 h-10",
      color: "bg-primary-400/20 dark:bg-primary-600/20",
      animation: { y: [0, 15, 0], duration: 6 },
    },
    {
      id: 3,
      top: "30%",
      right: "8%",
      size: "w-12 h-12",
      color: "bg-slate-400/20 dark:bg-slate-600/20",
      animation: { y: [0, -15, 0], duration: 7 },
    },
    {
      id: 4,
      bottom: "15%",
    ...
    >
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <motion.p
              className="text-accent-600 dark:text-accent-400 font-semibold mb-4 text-lg"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent-500 to-primary-600 dark:from-accent-400 dark:to-primary-500">
                Tejas Patil
              </span>
            </motion.h1>
            <motion.h2
            ...
            >
              ...
              web applications with clean code and modern technologies.
            ...
            >
              <motion.a
                href="#projects"
                className="btn btn-primary shadow-lg hover:shadow-accent-500/30 bg-gradient-to-r from-accent-500 to-primary-600 hover:from-accent-600 hover:to-primary-700"
              ...
              <motion.a
                href="#contact"
                className="btn btn-outline border-2 hover:bg-slate-100/50 dark:hover:bg-slate-800/50"
                whileHover={{ scale: 1.05, y: -3 }}
                whileTap={{ scale: 0.95 }}
              >
                Get In Touch
          ...
          >
            <Tilt options={defaultTiltOptions}>
              <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96">
                ...
                <motion.div
                  className="absolute -bottom-5 -right-5 bg-white dark:bg-slate-800 p-3 rounded-full shadow-lg border-2 border-accent-400"
                  animate={{
                    rotate: [0, 10, -10, 0],
                  }}
                  transition={{
                ...
                >
                  <div className="w-14 h-14 rounded-full bg-gradient-to-r from-accent-500 to-primary-600 flex items-center justify-center text-white font-bold">
                    2+
                  </div>
                  <div className="absolute -bottom-2 -right-2 text-xs bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded-full">
                    Years Exp
                  </div>
                </motion.div>
                <motion.div
                  className="absolute -top-5 -left-5 bg-white dark:bg-slate-800 p-2 rounded-lg shadow-lg border-2 border-primary-400"
                  animate={{
                    y: [0, -5, 0],
                  }}
                  transition={{
        ...
        <AnimatePresence>
          ...
          >
            <motion.a
              href="#about"
              className="flex flex-col items-center text-slate-600 dark:text-slate-400 hover:text-primary-700 dark:hover:text-primary-400"
